...
# Segment timeline (1 s cross-dissolves): 01a 0-13 | 01b 12-25 | 02 24-48 | 03a 47-56.5 | 03b 55.5-71 | 04 70-94 | 05 93-117 | 06 116-138 | 07a 137-149 | 07b 148-158 | 08 (our solar system, rendered by ending.html) 157-164
set -e
...
cut sun_sdo           03a "-ss 6 -t 9.5"    "$STD"
cut sun_sdo           03b "-ss 19.6 -t 15.5" "$STD"
...
[v3][4]xfade=transition=fade:duration=1:offset=55.5[v3b];
...
[v9]fade=t=in:st=0:d=1,fade=t=out:st=162.5:d=1.5,format=yuv420p[out]" -map "[out]" -c:v libx264 -preset medium -crf 24 -movflags +faststart intro.mp4
