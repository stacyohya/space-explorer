...
# Segment timeline (1 s cross-dissolves): 01a 0-13 | 01b 12-25 | 02 24-48 | 03a 47-55.6 | 03b 54.6-71 | 04 70-94 | 05 93-117 | 06 116-138 | 07a 137-149 | 07b 148-158 | 08 (our solar system, rendered by ending.html) 157-167
set -e
...
[v9]fade=t=in:st=0:d=1,fade=t=out:st=165.5:d=1.5,format=yuv420p[out]" -map "[out]" -c:v libx264 -preset medium -crf 24 -movflags +faststart intro.mp4
