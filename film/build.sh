...
# Segment timeline (1 s cross-dissolves): 01a 0-13 | 01b 12-25 | 02 24-48 | 03 47-71 | 04 70-94 | 05 93-117 | 06 116-138 | 07a 137-149 | 07b 148-158 | 08 (our solar system, rendered by ending.html) 157-169
set -e
...
ffmpeg -loglevel error -y -i seg/01a.mp4 -i seg/01b.mp4 -i seg/02.mp4 -i seg/03.mp4 -i seg/04.mp4 -i seg/05.mp4 -i seg/06.mp4 -i seg/07a.mp4 -i seg/07b.mp4 -i seg/08_end.mp4 -filter_complex "
...
[v8][9]xfade=transition=fade:duration=1:offset=157[v9];
[v9]fade=t=in:st=0:d=1,fade=t=out:st=167.5:d=1.5,format=yuv420p[out]" -map "[out]" -c:v libx264 -preset medium -crf 24 -movflags +faststart intro.mp4
